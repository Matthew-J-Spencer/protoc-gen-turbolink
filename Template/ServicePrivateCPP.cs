...
foreach(GrpcService service in s.ServiceArray)
{
	foreach (GrpcServiceMethod method in service.MethodArray)
	{
		if(!method.ClientStreaming) {
            ...
            #line default
            #line hidden
            this.Write("LambdaWrapper::OnResponse(FGrpcContextHandle _Handle, const FGrpcResult& GrpcResu" +
                    "lt, const ");
            ...
            #line default
            #line hidden
            this.Write("LambdaWrapper::OnContextStateChanged(FGrpcContextHandle _Handle, EGrpcContextStat" +
